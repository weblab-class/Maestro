...
const tutorialPages = [
  <div key="1">
    ...
    <p>
      You are currently on the <strong className="bolded-words">SEARCH MENU</strong> page. Here, you
      can view your published Guys, explore other users' creations, and select Guys to make music
      with in the Composer.
    </p>
    <p>Step through this tutorial to learn how to use this page.</p>
  </div>,
  <div key="2">
    <h3>Explore other user's creations:</h3>
    <ul>
      <li>Search for Guys by Guy name or creator username in the search bar.</li>
      <li>
        Click on a Guy in the left panel to select it. Then, click an icon in the right panel to add
        it to your list of Guys to use in the Composer!
      </li>
  ...
  <div key="3">
    ...
    <ul>
      ...
      <li>
        <code>Shift + #row + #column</code>: Insert a Guy into your Guy list to use in the Composer.
      </li>
    </ul>
  </div>,
];
