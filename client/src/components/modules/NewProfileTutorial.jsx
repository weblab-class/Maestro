...
const tutorialPages = [
  <div key="1">
    ...
    <p>
      You are currently on the <strong className="bolded-words">PROFILE</strong> page. Here, you can
      customize your Maestro persona and navigate to your created Guys.
    </p>
    <p>Step through this tutorial to learn how to use this page.</p>
  </div>,
  <div key="2">
    <h3>To edit your profile:</h3>
    <ul>
