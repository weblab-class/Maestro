      ...
      {isPopupOpen && (
        <div className="popup-overlay">
          <div className="popup-content">
            ...
            <p>
              You are currently on the <strong className="bolded-words">PROFILE</strong> page.
            </p>
            <p>How to use this page:</p>
            <ul className="list-spacing">
              <li>
                Your Profile is where you can customize your Maestro persona and view your created
                Guys.
              </li>
